...
--2.In-game requirements: Script starts at Master Rahool's purchase interface / more than 240000 Glimmer / 45 empty space in armor(9 for each armor) / unlocked all 5 of Midnight Oil Suit
...
function buyG()
    for i = 1, 24 do
        if (IsKeyLockOn("capslock")) then
            MoveMouseTo(50133, 11111)       --material position from left to right: 46820 / 50133 / 53547 / 56962  (would change everyday)
            Sleep(700)
            PressAndReleaseMouseButton(1)
            Sleep(700)
            PressAndReleaseMouseButton(1)
